...
class AccountReport(models.AbstractModel):
    ...
    def open_general_ledger(self, options, params=None):
        ...
        action = self.env["ir.actions.actions"]._for_xml_id("dv_account_reports_base.action_account_report_general_ledger")
    ...
    def open_report_export_wizard(self, options):
        ...
        """
        new_wizard = self.env['dv_account_reports_base.export.wizard'].create({'report_model': self._name,'report_id': self.id})
