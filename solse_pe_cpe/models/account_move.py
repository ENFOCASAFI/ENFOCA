...
class AccountMove(models.Model):
	...
	total_operaciones_gravadas = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_gravadas_dolar = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_exoneradas = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_exoneradas_dolar = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_gratuitas = fields.Monetary(store=False, readonly=True, compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_gratuitas_dolar = fields.Monetary(store=False, readonly=True, compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_inafectas = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_inafectas_dolar = fields.Monetary(store=False, readonly=True,compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_exportadas = fields.Monetary(store=False, readonly=True, compute='_compute_amount_reporte', track_visibility='always')
	total_operaciones_exportadas_dolar = fields.Monetary(store=False, readonly=True, compute='_compute_amount_reporte', track_visibility='always')
