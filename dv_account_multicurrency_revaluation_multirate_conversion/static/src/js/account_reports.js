odoo.define('dv_account_multicurrency_revaluation_multirate.account_report', function (require) {
'use strict';

var Widget = require('web.Widget');
var RelationalFields = require('web.relational_fields');
var StandaloneFieldManagerMixin = require('web.StandaloneFieldManagerMixin');
var accountReportsWidget = require('dv_account_reports_base.account_report');
...
accountReportsWidget.include({
    custom_events: _.extend({}, accountReportsWidget.prototype.custom_events, {
        'value_changed': function (ev) {
            ...
            self.report_options.currency_type = ev.data.currency_type;
            self.report_options.available_currency_types = ev.data.available_currency_types;
